...
namespace detail {
    ...
    */
    ...
    constexpr auto make_visit_function() {
        using ViewType = entt::view<entt::get_t<T>>;
    ...
    */
    ...
    struct visit_function_array {
        using ViewsTupleType = std::tuple<entt::view<entt::get_t<Ts>, entt::exclude_t<>>...>;
...
void visit_component([[maybe_unused]] std::tuple<Ts...>, IndexType index, entt::entity entity,
                     const std::tuple<entt::view<entt::get_t<Ts>, entt::exclude_t<>>...> &views_tuple,
                     VisitorType visitor) {
