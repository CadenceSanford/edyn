...
using orientation_view_t = entt::view<entt::get_t<orientation>>;
using material_view_t = entt::view<entt::get_t<material>>;
using mesh_shape_view_t = entt::view<entt::get_t<mesh_shape>>;
using paged_mesh_shape_view_t = entt::view<entt::get_t<paged_mesh_shape>>;
...
using detect_collision_body_view_t = entt::view<entt::get_t<AABB, shape_index, position, orientation>>;

using origin_view_t = entt::view<entt::get_t<origin>>;
